...
function UserAddForm() {
  ...
  const onSubmit = (user: ITypeUserAddForm) => {
    UsersService.createUser(token as string, user as ITypeUser)
      .then(() => {
        setMessage({
          type: 'success',
    ...
    <form onSubmit={handleSubmit(onSubmit)} className='userAddForm'>
      <div className='row'>
        <div className='item'>
          ...
          />
          {errors?.sn && (
            <p className='error'>{errors.sn.message || 'Erreur inconnue, veuillez réessayer'}</p>
          )}
        </div>
        <div className='item'>
          ...
          />
          {errors?.cn && (
            <p className='error'>{errors.cn.message || 'Erreur inconnue, veuillez réessayer'}</p>
          )}
        </div>
      </div>
